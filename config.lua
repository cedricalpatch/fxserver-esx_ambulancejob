...
Config.HelicopterSpawner = {
  SpawnPoint  = {x = 313.19775390625,y = -1465.1190185547,z = 45.509494781494 },
  Heading     = 0.0
}
...
Config.Zones = {
  ...
  AmbulanceActions = {
    Pos  = {x = 269.96328735352,y = -1363.5043945313,z = 23.537796020508 },
    Size = { x = 1.5, y = 1.5, z = 1.0 },
    Type = 1
  },

  VehicleSpawner = {
    Pos  = {x = 391.15850830078,y = -1432.6673583984,z = 28.435235977173 },
    Size = { x = 1.5, y = 1.5, z = 1.0 },
    Type = 1
  },

  VehicleSpawnPoint = {
    Pos  = {x = 409.94882202148,y = -1424.4831542969,z = 28.441572189331 },
    Size = { x = 1.5, y = 1.5, z = 1.0 },
    Type = -1
  },

  VehicleDeleter = {
    Pos  = {x = 375.38256835938,y = -1443.1782226563,z = 28.431550979614 },
...
--coffre de entreprise menu patron: {x = 232.99565124512,y = -1371.9670410156,z = 38.534370422363 },